...
const SETTLEMENT_OPTS = [['on_confirmation', 'On confirmation'], ['maturity', 'At maturity (harvest date)'], ['tranches', 'Progress payments (tranches)']];
...
export const POST_TYPE_FORMS = {
  ...
  plan_producer: {
    ...
    fields: [
      ...
      { key: 'tranche_count', label: 'Number of tranches (if progress payments)', kind: 'number', payload: true },
